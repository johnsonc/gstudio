...
urlpatterns = patterns('gnowsys_ndf.ndf.views.ajax_views',                        
                       ...
                       url(r'^topic_details_only/(?P<node_id>[\w-]+)$', 'topic_details_only', name='topic_details_only'),
                       ...
                       url(r'^get_tree_hierarchy_json/(?P<node_id>[\w-]+)$', 'get_tree_hierarchy_json', name='get_tree_hierarchy_json'),
